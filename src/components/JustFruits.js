...
function  JustFruits() {
    ...
    let filteredData = context.map(i => { return  i.filter(el => { return el.category_url === "/shop/categories/Fruits" ||  el.category_url === "/shop/categories/undefined"  })})
